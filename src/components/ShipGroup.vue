<template>
    <article
        class="rounded-lg flex border border-gray-400 dark:bg-gray-900 p-6 mt-4 hover:shadow-md transition-shadow duration-300"
...
const ships = computed(() => starStore.getShips);
