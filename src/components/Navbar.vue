                ...
                <div class="flex items-center gap-4 text-sm">
                    <div class="sm:flex items-center sm:gap-4">
                        ...
                        <div class="hidden sm:flex">
                            <div @click="authStore.logout" class="rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium text-teal-600 dark:bg-gray-800 dark:text-white dark:hover:text-white/75 cursor-pointer"
                                >
                                Logout
                            </div>
                        </div>
